...
func (h *HTTPClient) SendJSON(endpoint string, method string, payload map[string]any) (string, error) {
...
func (h *HTTPClient) SendFromEncoded(endpoint, method string, payload map[string]string) (string, error) {
